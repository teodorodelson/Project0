...
loginRouter.post('/login', async (req, res) => {
    ...
    try {
        ...
        const result_user = await client.query(`SELECT user_accounts.username from user_accounts Where username = '${username}';`);
        ...
        const result_password = await client.query(`SELECT user_accounts.password from user_accounts Where password = '${password}';`);
